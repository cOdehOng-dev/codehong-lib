...
class HongGraphLinePlayground(
    ...
    override val widgetType: HongWidgetType = HongWidgetType.GRAPH_LINE
    ...
    fun injectPreview(
        ...
        HorizontalOptionView(activity).set(
            ...
            rightOptionView = PlaygroundManager.labelInputPreview(
                activity,
                input = inject.graphLineWidth.toFigureString(),
                label = "그래프 선 두께",
                useOnlyNumber = true,
                useTopPadding = true
            ) {
