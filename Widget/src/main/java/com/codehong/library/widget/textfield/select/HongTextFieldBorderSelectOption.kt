...
data class HongTextFieldBorderSelectOption(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as HongTextFieldBorderSelectOption
        ...
        if (useDirectInput != other.useDirectInput) return false
        if (onSelectionClick != other.onSelectionClick) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + useDirectInput.hashCode()
        result = 31 * result + onSelectionClick.hashCode()
        result = 31 * result + onChangeInput.hashCode()
        return result
    }

    override fun toString(): String {
        return "HongTextFieldBorderSelectOption(" +
                "type=$type, " +
