...
import com.codehong.library.widget.databinding.HonglibViewUnderlineTextFieldBinding
...
class HongUnderlineTextFieldView @JvmOverloads constructor(
    ...
    private val binding =
        HonglibViewUnderlineTextFieldBinding.inflate(LayoutInflater.from(context), this, true)
    ...
    fun set(
        ...
        binding.vUnderline.layoutParams = binding.vUnderline.layoutParams.apply {
            this.height = context.dpToPx(option.underlineHeight)
        }
        binding.vUnderline.setBackgroundColor(option.underlineOutFocusColorHex.parseColor())
        ...
        with(binding.etInput) {
            setOnFocusChangeListener { _, hasFocus ->
                ...
                if (hasFocus) {
                    binding.vUnderline.setBackgroundColor(option.underlineFocusColorHex.parseColor())
                } else {
                    binding.vUnderline.setBackgroundColor(option.underlineOutFocusColorHex.parseColor())
                }
            }
